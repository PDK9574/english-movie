...
namespace Assets
{
    public class SqlAccess
    {
        ...
        private static string database = "english";//資料庫名
        private static string host = "152.70.110.2";//資料庫ip
        private static string username = "english";//使用者名稱
        private static string password = "@bcd1234";//密碼
        private static string port = "3306";//port 
        
        // 自己的資料庫

        // public static MySqlConnection mySqlConnection;//連線類物件
        // private static string database = "chou";//資料庫名
        // private static string host = "127.0.0.1";//資料庫ip
        // private static string username = "englishUser";//使用者名稱
        // private static string password = "12345";//密碼
        //  private static string port = "3306";//port 
